...
def _render_ascii_glyph(ch: int) -> bytes:
    ...
    This generates pixel-perfect glyphs for digits, uppercase,
    lowercase, and common symbols. Not every glyph is beautiful,
    but they're all legible.
    """
    # Simple glyph data — just enough to be recognizable
    # Each entry is a list of 16 hex values (one per row)
    _GLYPH_DATA = {
        # Digits
        ord('0'): [0x3C,0x66,0x6E,0x76,0x66,0x66,0x3C,0x00]*2,
        ord('1'): [0x18,0x38,0x18,0x18,0x18,0x18,0x7E,0x00]*2,
        ord('2'): [0x3C,0x66,0x06,0x0C,0x18,0x30,0x7E,0x00]*2,
        ord('3'): [0x3C,0x66,0x06,0x1C,0x06,0x66,0x3C,0x00]*2,
        ord('4'): [0x0C,0x1C,0x2C,0x4C,0x7E,0x0C,0x0C,0x00]*2,
        ord('5'): [0x7E,0x60,0x7C,0x06,0x06,0x66,0x3C,0x00]*2,
        ord('6'): [0x3C,0x60,0x7C,0x66,0x66,0x66,0x3C,0x00]*2,
        ord('7'): [0x7E,0x06,0x0C,0x18,0x18,0x18,0x18,0x00]*2,
        ord('8'): [0x3C,0x66,0x66,0x3C,0x66,0x66,0x3C,0x00]*2,
        ord('9'): [0x3C,0x66,0x66,0x3E,0x06,0x06,0x3C,0x00]*2,
        # Uppercase
        ord('A'): [0x18,0x3C,0x66,0x66,0x7E,0x66,0x66,0x00]*2,
        ord('B'): [0x7C,0x66,0x66,0x7C,0x66,0x66,0x7C,0x00]*2,
        ord('C'): [0x3C,0x66,0x60,0x60,0x60,0x66,0x3C,0x00]*2,
        ord('D'): [0x78,0x6C,0x66,0x66,0x66,0x6C,0x78,0x00]*2,
        ord('E'): [0x7E,0x60,0x60,0x7C,0x60,0x60,0x7E,0x00]*2,
        ord('F'): [0x7E,0x60,0x60,0x7C,0x60,0x60,0x60,0x00]*2,
        ord('G'): [0x3C,0x66,0x60,0x6E,0x66,0x66,0x3E,0x00]*2,
        ord('H'): [0x66,0x66,0x66,0x7E,0x66,0x66,0x66,0x00]*2,
        ord('I'): [0x3C,0x18,0x18,0x18,0x18,0x18,0x3C,0x00]*2,
        ord('J'): [0x1E,0x0C,0x0C,0x0C,0x0C,0x6C,0x38,0x00]*2,
        ord('K'): [0x66,0x6C,0x78,0x70,0x78,0x6C,0x66,0x00]*2,
        ord('L'): [0x60,0x60,0x60,0x60,0x60,0x60,0x7E,0x00]*2,
        ord('M'): [0x63,0x77,0x7F,0x6B,0x63,0x63,0x63,0x00]*2,
        ord('N'): [0x66,0x76,0x7E,0x7E,0x6E,0x66,0x66,0x00]*2,
        ord('O'): [0x3C,0x66,0x66,0x66,0x66,0x66,0x3C,0x00]*2,
        ord('P'): [0x7C,0x66,0x66,0x7C,0x60,0x60,0x60,0x00]*2,
        ord('Q'): [0x3C,0x66,0x66,0x66,0x6E,0x3C,0x0E,0x00]*2,
        ord('R'): [0x7C,0x66,0x66,0x7C,0x6C,0x66,0x66,0x00]*2,
        ord('S'): [0x3C,0x66,0x60,0x3C,0x06,0x66,0x3C,0x00]*2,
        ord('T'): [0x7E,0x18,0x18,0x18,0x18,0x18,0x18,0x00]*2,
        ord('U'): [0x66,0x66,0x66,0x66,0x66,0x66,0x3C,0x00]*2,
        ord('V'): [0x66,0x66,0x66,0x66,0x66,0x3C,0x18,0x00]*2,
        ord('W'): [0x63,0x63,0x63,0x6B,0x7F,0x77,0x63,0x00]*2,
        ord('X'): [0x66,0x66,0x3C,0x18,0x3C,0x66,0x66,0x00]*2,
        ord('Y'): [0x66,0x66,0x66,0x3C,0x18,0x18,0x18,0x00]*2,
        ord('Z'): [0x7E,0x06,0x0C,0x18,0x30,0x60,0x7E,0x00]*2,
        # Lowercase
        ord('a'): [0x00,0x00,0x3C,0x06,0x3E,0x66,0x3E,0x00]*2,
        ord('b'): [0x60,0x60,0x7C,0x66,0x66,0x66,0x7C,0x00]*2,
        ord('c'): [0x00,0x00,0x3C,0x66,0x60,0x66,0x3C,0x00]*2,
        ord('d'): [0x06,0x06,0x3E,0x66,0x66,0x66,0x3E,0x00]*2,
        ord('e'): [0x00,0x00,0x3C,0x66,0x7E,0x60,0x3C,0x00]*2,
        ord('f'): [0x1C,0x30,0x7C,0x30,0x30,0x30,0x30,0x00]*2,
        ord('g'): [0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x3C]*2,
        ord('h'): [0x60,0x60,0x7C,0x66,0x66,0x66,0x66,0x00]*2,
        ord('i'): [0x18,0x00,0x38,0x18,0x18,0x18,0x3C,0x00]*2,
        ord('j'): [0x0C,0x00,0x0C,0x0C,0x0C,0x0C,0x6C,0x38]*2,
        ord('k'): [0x60,0x60,0x66,0x6C,0x78,0x6C,0x66,0x00]*2,
        ord('l'): [0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00]*2,
        ord('m'): [0x00,0x00,0x66,0x7F,0x7F,0x6B,0x63,0x00]*2,
        ord('n'): [0x00,0x00,0x7C,0x66,0x66,0x66,0x66,0x00]*2,
        ord('o'): [0x00,0x00,0x3C,0x66,0x66,0x66,0x3C,0x00]*2,
        ord('p'): [0x00,0x00,0x7C,0x66,0x66,0x7C,0x60,0x60]*2,
        ord('q'): [0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x06]*2,
        ord('r'): [0x00,0x00,0x7C,0x66,0x60,0x60,0x60,0x00]*2,
        ord('s'): [0x00,0x00,0x3E,0x60,0x3C,0x06,0x7C,0x00]*2,
        ord('t'): [0x30,0x30,0x7C,0x30,0x30,0x30,0x1C,0x00]*2,
        ord('u'): [0x00,0x00,0x66,0x66,0x66,0x66,0x3E,0x00]*2,
        ord('v'): [0x00,0x00,0x66,0x66,0x66,0x3C,0x18,0x00]*2,
        ord('w'): [0x00,0x00,0x63,0x6B,0x7F,0x7F,0x36,0x00]*2,
        ord('x'): [0x00,0x00,0x66,0x3C,0x18,0x3C,0x66,0x00]*2,
        ord('y'): [0x00,0x00,0x66,0x66,0x66,0x3E,0x06,0x3C]*2,
        ord('z'): [0x00,0x00,0x7E,0x0C,0x18,0x30,0x7E,0x00]*2,
        # Symbols
        ord('!'): [0x18,0x18,0x18,0x18,0x18,0x00,0x18,0x00]*2,
        ord('"'): [0x66,0x66,0x24,0x00,0x00,0x00,0x00,0x00]*2,
        ord('#'): [0x24,0x24,0x7E,0x24,0x7E,0x24,0x24,0x00]*2,
        ord('$'): [0x18,0x3E,0x60,0x3C,0x06,0x7C,0x18,0x00]*2,
        ord('%'): [0x62,0x66,0x0C,0x18,0x30,0x66,0x46,0x00]*2,
        ord('&'): [0x38,0x6C,0x38,0x76,0xDC,0xCC,0x76,0x00]*2,
        ord("'"): [0x18,0x18,0x30,0x00,0x00,0x00,0x00,0x00]*2,
        ord('('): [0x0C,0x18,0x30,0x30,0x30,0x18,0x0C,0x00]*2,
        ord(')'): [0x30,0x18,0x0C,0x0C,0x0C,0x18,0x30,0x00]*2,
        ord('*'): [0x00,0x66,0x3C,0xFF,0x3C,0x66,0x00,0x00]*2,
        ord('+'): [0x00,0x18,0x18,0x7E,0x18,0x18,0x00,0x00]*2,
        ord(','): [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x30]*2,
        ord('-'): [0x00,0x00,0x00,0x7E,0x00,0x00,0x00,0x00]*2,
        ord('.'): [0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x00]*2,
        ord('/'): [0x02,0x06,0x0C,0x18,0x30,0x60,0x40,0x00]*2,
        ord(':'): [0x00,0x00,0x18,0x18,0x00,0x18,0x18,0x00]*2,
        ord(';'): [0x00,0x00,0x18,0x18,0x00,0x18,0x18,0x30]*2,
        ord('<'): [0x06,0x0C,0x18,0x30,0x18,0x0C,0x06,0x00]*2,
        ord('='): [0x00,0x00,0x7E,0x00,0x7E,0x00,0x00,0x00]*2,
        ord('>'): [0x60,0x30,0x18,0x0C,0x18,0x30,0x60,0x00]*2,
        ord('?'): [0x3C,0x66,0x06,0x0C,0x18,0x00,0x18,0x00]*2,
        ord('@'): [0x3C,0x66,0x6E,0x6E,0x60,0x62,0x3C,0x00]*2,
        ord('['): [0x3C,0x30,0x30,0x30,0x30,0x30,0x3C,0x00]*2,
        ord('\\'): [0x40,0x60,0x30,0x18,0x0C,0x06,0x02,0x00]*2,
        ord(']'): [0x3C,0x0C,0x0C,0x0C,0x0C,0x0C,0x3C,0x00]*2,
        ord('^'): [0x18,0x3C,0x66,0x00,0x00,0x00,0x00,0x00]*2,
        ord('_'): [0x00,0x00,0x00,0x00,0x00,0x00,0x7E,0x00]*2,
        ord('`'): [0x18,0x18,0x0C,0x00,0x00,0x00,0x00,0x00]*2,
        ord('{'): [0x0E,0x18,0x18,0x70,0x18,0x18,0x0E,0x00]*2,
        ord('|'): [0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00]*2,
        ord('}'): [0x70,0x18,0x18,0x0E,0x18,0x18,0x70,0x00]*2,
        ord('~'): [0x76,0xDC,0x00,0x00,0x00,0x00,0x00,0x00]*2,
    }
    if ch in _GLYPH_DATA:
        return bytes(_GLYPH_DATA[ch][:16])
